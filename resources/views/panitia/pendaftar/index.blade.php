<x-panel-layout>
    <x-slot name="title">Daftar Pendaftar</x-slot>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">No. Daftar</th>
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Nama Siswa</th>
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider">Jalur</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class="px-6 text-center py-4 whitespace-nowrap font-medium text-gray-900">{{ $reg->nomor_pendaftaran }}</td>
                                <td class="px-6 text-center py-4 whitespace-nowrap">{{ $reg->student->nama_lengkap }}</td>
                                <td class="px-6 text-center py-4 whitespace-nowrap">{{ $reg->jalur->nama }}</td>
